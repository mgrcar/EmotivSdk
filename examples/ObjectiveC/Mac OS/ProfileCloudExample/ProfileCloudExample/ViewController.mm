...
-(IBAction)Login:(id)sender{
    ...
    if(EC_Login([self.userName.stringValue cStringUsingEncoding:NSUTF8StringEncoding], [self.pass.stringValue cStringUsingEncoding:NSUTF8StringEncoding])) {
...
-(IBAction)Delete:(id)sender{
    ...
    if(EC_DeleteUserProfile(userCloudID, profileID)) {
